...
graficos_series <- function(df="tasas_por_sexo_df", 
  ...
  datagraf <- resultados$tablas_04_06[[df]] %>%                               # Dataframe para 2004-06
  bind_rows(., resultados$tablas_16_18[[df]]) %>%                             # Daraframe para 2016-17
  ...
  if(guardar){
    ggsave(nombre_archivo, plot = grafico, scale = 0.75, width = 10, height = 7, units = "in")
  }
...
graficos_series(df="tasas_por_sexo_df", 
                ...
                faceta = "indicador",
                guardar = TRUE,
                nombre_archivo = "Resultados/1_TA_TE_Sexo.png")
```
