...
vec_dirs <- function(path = "Fuentes/EPH_2004-06/"){
...
tablas_04_06 <- multiples_cuatris(vector_directorios = vec_dirs("Fuentes/EPH_2004-06/"))

tablas_16_18 <- multiples_cuatris(vector_directorios = vec_dirs("Fuentes/EPH_2016-18/"))

resultados <- list("tablas_04_06"= tablas_04_06,
                   "tablas_16_18"=tablas_16_18)

saveRDS(resultados,"Resultados/tablas_resultados.RDS")
openxlsx::write.xlsx(tablas_04_06, "Resultados/tablas_resultados_04_06.xlsx")
openxlsx::write.xlsx(tablas_16_18, "Resultados/tablas_resultados_16_18.xlsx")
